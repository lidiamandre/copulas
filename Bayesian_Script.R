...
inits1<-list(alpha=2.0,beta=0.5,mu=1.5,sigma=0.3,rho=0.5)
inits2<-list(alpha=5.0,beta=1.5,mu=2.0,sigma=0.7,rho=0.2)
...
gaussian_a<-autorun.jags(gaussian,monitor=c("alpha","beta","mu","sigma","rho"), data=data,n.chains=2, inits=inits,startsample=4000,thin=30)
summary(gaussian_a)
plot(gaussian_a)
...
inits1<-list(k=1.0,c=5.0,lambda=0.1,alpha=1.5,beta=0.3,rho=0.2)
inits2<-list(k=6.0,c=1.0,lambda=0.5,alpha=2.5,beta=0.7,rho=0.5)
inits<-list(inits1,inits2)
...
gaussian_sp<-autorun.jags(gaussian,monitor=c("k","c","lambda","alpha","beta","rho"), data=data,n.chains=2, inits=inits,startsample=4000,thin=30)
summary(gaussian_sp)
plot(gaussian_sp)
...
inits1<-list(alpha=1.5,beta=0.3,omega=1.5,b=0.001,rho=0.5)
inits2<-list(alpha=2.5,beta=0.7,omega=1.0,b=0.005,rho=0.2)
inits<-list(inits1,inits2)
...
gaussian_su<-autorun.jags(gaussian,monitor=c("alpha","beta","omega","delta","rho"), data=data,n.chains=2, inits=inits,startsample=4000,thin=30)
summary(gaussian_su)
plot(gaussian_su)
